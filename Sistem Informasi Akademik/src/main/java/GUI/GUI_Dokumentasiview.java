...
public class GUI_Dokumentasiview extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Dokumentasi Nilai Mahasiswa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_Dokumentasiview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_Dokumentasiview().setVisible(true);
            }
        });
    }
