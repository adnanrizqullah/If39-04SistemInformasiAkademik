...
public class CekIPKdanIPSContext {
    ...
    public void notif_nilai_akhir_final_tidak_akan_muncul_di_masing_masing_akun_mahasiswa() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Ketika("^Notif nilai akhir final belum masuk ke masing-masing akun Mahasiswa$")
    public void notif_nilai_akhir_final_belum_masuk_ke_masing_masing_akun_Mahasiswa() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Maka("^respon Mahasiswa menunggu notif nilai akhir final masuk$")
    public void respon_Mahasiswa_menunggu_notif_nilai_akhir_final_masuk() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
}
